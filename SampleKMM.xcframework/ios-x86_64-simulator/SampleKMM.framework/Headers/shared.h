...
@class SharedRocketLaunchEntitys, SharedLaunchesModule, SharedLaunchesUseCase, SharedKotlinUnit, SharedLinksEntityCompanion, SharedRocketEntityCompanion, SharedRocketLaunchEntitysCompanion, SharedLinksEntity, SharedRocketEntity, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedLaunchesRepository, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinIterator, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
@protocol SharedLaunchesRepository
@required
...
*/
- (void)getAllWithCompletionHandler:(void (^)(NSArray<SharedRocketLaunchEntitys *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getAll(completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LaunchesUseCase")))
@interface SharedLaunchesUseCase : SharedBase
- (instancetype)initWithRepository:(id<SharedLaunchesRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));

/**
 @note This method converts instances of Exception to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)executeWithCompletionHandler:(void (^)(NSArray<SharedRocketLaunchEntitys *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("execute(completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LaunchesModule")))
@interface SharedLaunchesModule : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)launchesModule __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLaunchesModule *shared __attribute__((swift_name("shared")));
@property (readonly) SharedLaunchesUseCase *launchesUseCase __attribute__((swift_name("launchesUseCase")));
@end;

__attribute__((swift_name("LaunchesCacheDataSource")))
@protocol SharedLaunchesCacheDataSource
@required
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)clearWithCompletionHandler:(void (^)(SharedKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("clear(completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveLaunches:(NSArray<SharedRocketLaunchEntitys *> *)launches completionHandler:(void (^)(SharedKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("save(launches:completionHandler:)")));
@end;

__attribute__((swift_name("LaunchesRemoteDataSource")))
@protocol SharedLaunchesRemoteDataSource
@required
...
@interface SharedLinksEntity : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedLinksEntityCompanion *companion __attribute__((swift_name("companion")));
...
@interface SharedLinksEntityCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLinksEntityCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RocketEntity")))
@interface SharedRocketEntity : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedRocketEntityCompanion *companion __attribute__((swift_name("companion")));
...
@interface SharedRocketEntityCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRocketEntityCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RocketLaunchEntitys")))
@interface SharedRocketLaunchEntitys : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedRocketLaunchEntitysCompanion *companion __attribute__((swift_name("companion")));
...
@property SharedBoolean * _Nullable launchSuccess __attribute__((swift_name("launchSuccess")));
@property int32_t launchYear __attribute__((swift_name("launchYear")));
@property SharedLinksEntity * _Nullable linksEntity __attribute__((swift_name("linksEntity")));
@property NSString *missionName __attribute__((swift_name("missionName")));
@property SharedRocketEntity * _Nullable rocketEntity __attribute__((swift_name("rocketEntity")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RocketLaunchEntitys.Companion")))
@interface SharedRocketLaunchEntitysCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRocketLaunchEntitysCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
